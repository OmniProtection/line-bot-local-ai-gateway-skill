...
> 給台灣開發者、團隊與個人試用的 **本地優先 LINE AI Bot 範本**。  
...
它不是 LINE 官方工具，也不是雲端 SaaS Bot 平台；它是一個開源範本，幫你把 LINE Webhook、本地模型、記憶、搜尋、知識庫、安全檢查先整理好，讓你可以快速測試、修改、延伸。
...
| Codex Skill 範本 | 作為可重複產生、審查、驗證 LINE Bot 專案的 Skill 範本。 |
